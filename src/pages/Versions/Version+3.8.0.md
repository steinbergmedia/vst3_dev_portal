...
- Interface changes:
  - Support for MIDI 2.0: new interface for *IMidiLearn2* and *IMidiMapping2*. These new interfaces replace the previous interfaces *IMidiLearn* and *IMidiMapping*.
  - Add missing ControllerNumbers enum for MIDI 1.0 System message.
