...
This tutorial explains how to create a new audio plug-in by using the ***[VST 3 Project Generator](../What+is+the+VST+3+SDK/Project+Generator.md)*** included in the **VST SDK** and how to add some basic features.
...
- You can use the [**helloworld** template](Creating+a+plug-in+with+VST+3+SDK+as+an+external+project.md).
...
The [**VST 3 Project Generator**](../What+is+the+VST+3+SDK/Project+Generator.md) application included in the **VST SDK**  is available for Windows and for macOS.
