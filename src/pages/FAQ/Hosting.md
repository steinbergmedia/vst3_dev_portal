...
No, this is not the typical use case. However, it could be used by plug-ins changing their internal-external representation (e.g., change of parameter count, number of IO...). For an initial host implementation, you can postpone it until a future version is released.
